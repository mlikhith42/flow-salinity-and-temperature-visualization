...
renderView1.CameraPosition = [249.5, 249.5, 1391.0758011394353]
renderView1.CameraFocalPoint = [249.5, 249.5, 24.5]
renderView1.CameraFocalDisk = 1.0
renderView1.CameraParallelScale = 292.31061480257915
...
calculator3.ResultArrayName = 'cos_grads'
calculator3.Function = 'abs(norm(ImageScalarsGradient).norm(ImageScalarsGradient_input_1))'

# create a new 'Threshold'
threshold4 = Threshold(Input=calculator3)
threshold4.Scalars = ['POINTS', 'cos_grads']
threshold4.ThresholdRange = [1e-06, 1.0000000000000004]
...
imageScalarsGradientLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 275.41046821894827, 0.865003, 0.865003, 0.865003, 550.8209364378965, 0.705882, 0.0156863, 0.14902]
...
imageScalarsGradientPWF.Points = [0.0, 0.0, 0.5, 0.0, 550.8209364378965, 1.0, 0.5, 0.0]
imageScalarsGradientPWF.ScalarRangeInitialized = 1

# trace defaults for the display properties.
appendAttributes2Display.Representation = 'Outline'
appendAttributes2Display.ColorArrayName = ['POINTS', 'ImageScalarsGradient']
appendAttributes2Display.LookupTable = imageScalarsGradientLUT
...
appendAttributes2Display.ScalarOpacityFunction = imageScalarsGradientPWF
...
# get color transfer function/color map for 'cos_grads'
cos_gradsLUT = GetColorTransferFunction('cos_grads')
cos_gradsLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 0.5000000000000002, 0.865003, 0.865003, 0.865003, 1.0000000000000004, 0.705882, 0.0156863, 0.14902]
cos_gradsLUT.ScalarRangeInitialized = 1.0

# get opacity transfer function/opacity map for 'cos_grads'
cos_gradsPWF = GetOpacityTransferFunction('cos_grads')
cos_gradsPWF.Points = [0.0, 0.0, 0.5, 0.0, 1.0000000000000004, 1.0, 0.5, 0.0]
cos_gradsPWF.ScalarRangeInitialized = 1

# trace defaults for the display properties.
calculator3Display.Representation = 'Surface'
calculator3Display.ColorArrayName = ['POINTS', 'cos_grads']
calculator3Display.LookupTable = cos_gradsLUT
...
calculator3Display.ScalarOpacityFunction = cos_gradsPWF
...
threshold3Display.ColorArrayName = ['POINTS', 'SALT']
threshold3Display.LookupTable = sALTLUT
...
threshold3Display.ScalarOpacityFunction = sALTPWF
...
threshold4Display.ColorArrayName = ['POINTS', 'cos_grads']
threshold4Display.LookupTable = cos_gradsLUT
threshold4Display.OSPRayScaleArray = 'cos_grads'
threshold4Display.OSPRayScaleFunction = 'PiecewiseFunction'
threshold4Display.SelectOrientationVectors = 'ImageScalarsGradient'
threshold4Display.ScaleFactor = 49.900000000000006
threshold4Display.SelectScaleArray = 'cos_grads'
threshold4Display.GlyphType = 'Arrow'
threshold4Display.GlyphTableIndexArray = 'cos_grads'
threshold4Display.GaussianRadius = 2.495
threshold4Display.SetScaleArray = ['POINTS', 'cos_grads']
threshold4Display.ScaleTransferFunction = 'PiecewiseFunction'
threshold4Display.OpacityArray = ['POINTS', 'cos_grads']
...
threshold4Display.ScalarOpacityFunction = cos_gradsPWF
threshold4Display.ScalarOpacityUnitDistance = 3.0727523672358505

# setup the color legend parameters for each legend in this view

# get color legend/bar for tEMPLUT in view renderView1
tEMPLUTColorBar = GetScalarBar(tEMPLUT, renderView1)
tEMPLUTColorBar.WindowLocation = 'UpperLeftCorner'
...
sALTLUTColorBar.WindowLocation = 'LowerLeftCorner'
...
imageScalarsGradientLUTColorBar.Position = [0.8906691800188501, 0.01509433962264151]
imageScalarsGradientLUTColorBar.Title = 'ImageScalarsGradient'
imageScalarsGradientLUTColorBar.ComponentTitle = 'Magnitude'

# set color bar visibility
imageScalarsGradientLUTColorBar.Visibility = 0
...
imageScalarsGradient_input_1LUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 374.85552140939035, 0.865003, 0.865003, 0.865003, 749.7110428187807, 0.705882, 0.0156863, 0.14902]
...
# set color bar visibility
imageScalarsGradient_input_1LUTColorBar.Visibility = 0

# get color transfer function/color map for 'angle_bw_grad'
angle_bw_gradLUT = GetColorTransferFunction('angle_bw_grad')
angle_bw_gradLUT.RGBPoints = [-284.67886987586775, 0.231373, 0.298039, 0.752941, 193001.7288220354, 0.865003, 0.865003, 0.865003, 386288.1365139467, 0.705882, 0.0156863, 0.14902]
angle_bw_gradLUT.ScalarRangeInitialized = 1.0

# get color legend/bar for angle_bw_gradLUT in view renderView1
angle_bw_gradLUTColorBar = GetScalarBar(angle_bw_gradLUT, renderView1)
angle_bw_gradLUTColorBar.Title = 'angle_bw_grad'
angle_bw_gradLUTColorBar.ComponentTitle = ''

# set color bar visibility
angle_bw_gradLUTColorBar.Visibility = 0

# get color transfer function/color map for 'result'
resultLUT = GetColorTransferFunction('result')
resultLUT.RGBPoints = [2.4479834435608353e-14, 0.231373, 0.298039, 0.752941, 1.1685081749965999e+35, 0.865003, 0.865003, 0.865003, 2.3370163499931998e+35, 0.705882, 0.0156863, 0.14902]
...
resultLUTColorBar.WindowLocation = 'UpperRightCorner'
resultLUTColorBar.Title = 'result'
resultLUTColorBar.ComponentTitle = 'Magnitude'

# set color bar visibility
resultLUTColorBar.Visibility = 0

# get color transfer function/color map for 'cos_grad'
cos_gradLUT = GetColorTransferFunction('cos_grad')
cos_gradLUT.RGBPoints = [-0.9999999999941763, 0.231373, 0.298039, 0.752941, 2.912003971289323e-12, 0.865003, 0.865003, 0.865003, 1.0000000000000004, 0.705882, 0.0156863, 0.14902]
cos_gradLUT.ScalarRangeInitialized = 1.0

# get color legend/bar for cos_gradLUT in view renderView1
cos_gradLUTColorBar = GetScalarBar(cos_gradLUT, renderView1)
cos_gradLUTColorBar.Title = 'cos_grad'
cos_gradLUTColorBar.ComponentTitle = ''

# set color bar visibility
cos_gradLUTColorBar.Visibility = 0

# get color legend/bar for cos_gradsLUT in view renderView1
cos_gradsLUTColorBar = GetScalarBar(cos_gradsLUT, renderView1)
cos_gradsLUTColorBar.Position = [0.8906691800188501, 0.01509433962264151]
cos_gradsLUTColorBar.Title = 'angle_between'
cos_gradsLUTColorBar.ComponentTitle = ''

# set color bar visibility
cos_gradsLUTColorBar.Visibility = 1
...
resultPWF.Points = [2.4479834435608353e-14, 0.0, 0.5, 0.0, 2.3370163499931998e+35, 1.0, 0.5, 0.0]
...
imageScalarsGradient_input_1PWF.Points = [0.0, 0.0, 0.5, 0.0, 749.7110428187807, 1.0, 0.5, 0.0]
imageScalarsGradient_input_1PWF.ScalarRangeInitialized = 1

# get opacity transfer function/opacity map for 'angle_bw_grad'
angle_bw_gradPWF = GetOpacityTransferFunction('angle_bw_grad')
angle_bw_gradPWF.Points = [-284.67886987586775, 0.0, 0.5, 0.0, 386288.1365139467, 1.0, 0.5, 0.0]
angle_bw_gradPWF.ScalarRangeInitialized = 1

# get opacity transfer function/opacity map for 'cos_grad'
cos_gradPWF = GetOpacityTransferFunction('cos_grad')
cos_gradPWF.Points = [-0.9999999999941763, 0.0, 0.5, 0.0, 1.0000000000000004, 1.0, 0.5, 0.0]
cos_gradPWF.ScalarRangeInitialized = 1
