...
calculator3.ResultArrayName = 'cos_gradz'
calculator3.Function = '90*(1+(norm(ImageScalarsGradient).norm(ImageScalarsGradient_input_1)))'
...
calculator3Display.ColorArrayName = ['POINTS', 'cos_gradz']
calculator3Display.LookupTable = cos_gradzLUT
calculator3Display.OSPRayScaleArray = 'cos_gradz'
...
calculator3Display.SelectScaleArray = 'cos_gradz'
calculator3Display.GlyphType = 'Arrow'
calculator3Display.GlyphTableIndexArray = 'cos_gradz'
calculator3Display.GaussianRadius = 2.495
calculator3Display.SetScaleArray = ['POINTS', 'cos_gradz']
calculator3Display.ScaleTransferFunction = 'PiecewiseFunction'
calculator3Display.OpacityArray = ['POINTS', 'cos_gradz']
...
calculator3Display.ScalarOpacityFunction = cos_gradzPWF
calculator3Display.IsosurfaceValues = [90.00000000026208]
calculator3Display.Slice = 24

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
calculator3Display.ScaleTransferFunction.Points = [5.241307388104133e-10, 0.0, 0.5, 0.0, 180.00000000000003, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
calculator3Display.OpacityTransferFunction.Points = [5.241307388104133e-10, 0.0, 0.5, 0.0, 180.00000000000003, 1.0, 0.5, 0.0]
...
# set color bar visibility
cos_gradzLUTColorBar.Visibility = 1
